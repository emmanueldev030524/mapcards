/** Google Maps-style pin markers with icons inside */
...
/**
 * Generate a Google Maps-style pin SVG as a data URL.
 * Pin shape: teardrop with icon inside.
 */
...
/**
 * Load all pin images into a MapLibre map instance
 */
export async function loadPinImages(map: { hasImage: (id: string) => boolean; addImage: (id: string, img: HTMLImageElement) => void }): Promise<void> {
